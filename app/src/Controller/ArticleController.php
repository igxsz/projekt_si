...
class ArticleController extends AbstractController
{
     ...
     */
    public function __construct(ArticleServiceInterface $articleService, TranslatorInterface $translator, ArticleRepository $articleRepository)
    {
    ...
    public function show(Request $request, CommentService $commentService, ArticleRepository $articleRepository, Article $article): Response
    {
        $pagination = $commentService->getPaginatedListByArticle($request->query->getInt('page', 1), $article);

        return $this->render('article/show.html.twig', ['article' => $article, 'pagination' => $pagination]);
    }
